			...
			<div class="container">
				...
				<div class="sideBar">
					...
					<ul>
						...
						<li><a href="board.html"> <i class="bx bxs-grid-alt"></i>
			...
			<div id="popup" class="popup">
				...
				<form id="insertForm" action="/employee/update_info" method="post">
					...
					<input type="text" name="address" id="address" placeholder="주소"
						...
						name="detail_address" placeholder="상세주소" required>
		...
		<c:otherwise>
			<div class="membership active">
				...
				<div class="employee_container">
					<a href="/employee/register_form" class="insert_employee">신규
						직원등록</a>
