...
<div id="addRoomModal" class="modal">
	<form id="addRoomForm"
		action="/reservation/admin/add?target=meetingRoom" method="post">
		<div class="modalContent addTargetModal">
			<h1>
			...
			<div class="addTargetInfo">
				<ul>
					<li><span>회의실 명</span>
						<div>
							<input type="text" name="name" id="name" data-label="회의실 명"
								oninput='handleOnInput(this, 10)'>
						</div></li>
					<li><span>회의실 위치</span>
						<div>
							<input type="text" name="location" id="location"
								data-label="회의실 위치" oninput='handleOnInput(this, 10)'>
						</div></li>
					<li><span>수용 인원</span>
						<div>
