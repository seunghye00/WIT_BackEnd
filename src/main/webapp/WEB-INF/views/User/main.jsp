												...
												<div class="eApprRows">
													<div class="eApprCols">
														결재 대기&nbsp;<i class='bx bx-file bx-flip-horizontal'
															style='color: #558bcf'></i> <span
															class="docuNum">${todoNum}</span>
													</div>
													<div class="eApprCols">
														참조&nbsp;<i class='bx bx-file bx-flip-horizontal'
															style='color: #558bcf'></i> <span
															class="docuNum">${refeNum}</span>
													</div>
												</div>
												<div class="eApprRows">
													<div class="eApprCols">
														기안 진행중&nbsp;<i class='bx bx-file bx-flip-horizontal'
															style='color: #558bcf'></i> <span
															class="docuNum">${apprNum}</span>
													</div>
													<div class="eApprCols">
														임시 저장&nbsp;<i class='bx bx-file bx-flip-horizontal'
															style='color: #558bcf'></i> <span
															class="docuNum">${saveNum}</span>
													</div>
												</div>
											</div>
										</div>
					...
					<div class="rightTop">
						...
						<div class="eApprBox">
							...
							<div class="input-container">
								<input type="text" name="nickname" id="nickname" placeholder="닉네임" required> <span
									class="valid-check error" id="nicknameCheck">&#x2716;</span>
							</div>
							<label id="resultNickname"></label>
							<button type="button" class="nickname-button" id="checkNickname">중복체크</button>
							<div class="input-container">
								<input type="text" name="ssn" id="ssn" placeholder="주민등록번호" required> <span
									class="valid-check error" id="ssnCheck">&#x2716;</span>
							</div>
							<label id="resultSSN"></label>
							<div class="input-container">
								<input type="text" name="phone" id="phone" placeholder="휴대폰" required> <span
									class="valid-check error" id="phoneCheck">&#x2716;</span>
							</div>
							<label id="resultPhone"></label>
							<div class="input-container">
								<input type="email" name="email" id="email" placeholder="이메일" required> <span
									class="valid-check error" id="emailCheck">&#x2716;</span>
							</div>
							<label id="resultEmail"></label> <input type="text" name="zip_code" id="zip_code"
								placeholder="우편주소" required readonly>
							<button type="button" class="address-button" id="postcode">주소
								찾기</button>
							<input type="text" name="address" id="address" placeholder="주소" required readonly> <input
								type="text" name="detail_address" placeholder="상세주소" required>
