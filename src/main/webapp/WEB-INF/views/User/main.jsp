								...
								<div class="contents">
									...
									<div class="center">
										...
										<div class="boardList">
											<div class="notiList">
												...
												<c:forEach var="board" items="${boardList}" varStatus="status">
													<div class="rows notiConts">
														<div class="cols boardSeq">
															<span class="bseq-${status.index + 1}">${status.index + 1}</span>
														</div>
											...
											<div class="notiList">
												<div class="titleTxt"><i class='bx bxs-tag-alt' style="margin-right:5px;" ></i> 공지사항 인기글</div>
												<div class="rows notiHeader">
													<div class="cols boardSeq">
														<span>No.</span>
													</div>
												...
												<c:forEach var="board" items="${noticeList}" varStatus="status">
													<div class="rows notiConts">
														<div class="cols boardSeq">
															<span class="seq-${status.index + 1}">${status.index + 1}</span>
														</div>
