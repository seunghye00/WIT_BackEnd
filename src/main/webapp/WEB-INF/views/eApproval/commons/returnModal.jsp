...
<div class="modalBack" id="returnModalBack">
	<div class="returnModal">
		<input type="hidden" value="${docuInfo.document_seq}" id="docuSeq">
		<div class="returnModalTitle">
			반려 코멘트 작성 <span class="closeModal">X</span>
		</div>
		<div class="returnComm">
			<textarea id="returnComm" data-label="반려 코멘트"
				oninput='handleOnInput(this, 300)'></textarea>
		</div>
