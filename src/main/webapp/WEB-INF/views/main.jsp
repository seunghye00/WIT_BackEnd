				...
				<script>
					...
					function toDetailBoard(e) {
						$.ajax({
							...
							window.location.href = "${pageContext.request.contextPath}/board/detail?boardCode=1&board_seq=" + $(e).data("seq")
						})
					...
					function toDetailNotice(e) {
						$.ajax({
							...
							window.location.href = "${pageContext.request.contextPath}/board/detail?boardCode=2&board_seq=" + $(e).data("seq")
						})
