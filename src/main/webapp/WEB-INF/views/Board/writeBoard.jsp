		...
		<body>
			<div id="container">
				<div class="sideBar">
					...
					<ul>
						<li><a href="#"> <i class='bx bxs-home-alt-2'></i> <span class="navItem">홈</span>
							</a> <span class="toolTip">홈</span></li>
						<li><a href="#"> <i class='bx bx-paperclip'></i> <span class="navItem">주소록</span>
						...
						<li><a href="#"> <i class='bx bx-calendar-alt'></i> <span class="navItem">캘린더</span>
							</a> <span class="toolTip">캘린더</span></li>
						<li><a href="#"> <i class='bx bxs-message-dots'></i> <span class="navItem">메신저</span>
							</a> <span class="toolTip">메신저</span></li>
						<li><a href="#"> <i class='bx bx-clipboard'></i> <span class="navItem">전자결재</span>
							</a> <span class="toolTip">전자결재</span></li>
						<li><a href="#"> <i class='bx bxs-briefcase-alt-2'></i> <span class="navItem">근태관리</span>
							</a> <span class="toolTip">근태관리</span></li>
						<li><a href="#"> <i class='bx bxs-check-square'></i> <span class="navItem">예약</span>
							</a> <span class="toolTip">예약</span></li>
						<li><a href="#"> <i class='bx bx-sitemap'></i> <span class="navItem">조직도</span>
				...
				<div class="main-content">
					<div class="header">
						...
						<!--마이페이지로 이동-->
						<span class="myName"> <!-- 				 <img src="../메인게임.webp"> -->
							<a href=" #">백민주 사원</a></span> <span class="logOut"><a href="#">LogOut</a></span>
					</div>
					<div class="contents">
						<div class="sideAbout">
							<div class="sideTxt">
							...
							<form action="/board/writeProc" method="post" enctype="multipart/form-data" id="submitForm">
								...
								<div class="writeWrapper">
									...
									<div class="formInputFileWrap">
										<input class="inputFile" id="upload" type="file" multiple name="files">
										<label class="labelFile" for="upload">파일선택</label> <span class="spanFile">선택된
											파일이 없습니다.</span>
									</div>
									<div class="writeBtns">
										<button type="button" class="btn btn-secondary" id="writeList">뒤로가기</button>
