    ...
    <div class="container">
        <div class="sideBar">
            ...
            <ul>
                ...
                <li><a href="board2.html"> <i class="bx bxs-grid-alt"></i> <span class="navItem">게시판</span>
                ...
                <li><a href="/attendance/attendance"> <i class='bx bxs-briefcase-alt-2'></i> <span class="navItem">근태관리</span>
                    ...
                    <div class="addressListPrivate">
                        <ul class="privateList">
                            <li class="toggleItem">
                                ...
                                <ul class="subList">
                                    <li><a href="/attendance/attendance_month" class="active">월간 근태현황</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
