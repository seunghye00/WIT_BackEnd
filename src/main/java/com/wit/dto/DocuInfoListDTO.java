...
public class DocuInfoListDTO {
	...
	public DocuInfoListDTO(int document_seq, String emp_no, String writer, Timestamp write_date, String emer_yn,
			String title, String read_yn, String status, String name, String last_appr, String last_appr_name,
			Timestamp done_date) {
		super();
	...
	// 문서 번호, 기안일, 문서 양식, 긴급, 제목, 기안자 사번, 문서 상태, 완료일 ( 결재 문서함 )
	public DocuInfoListDTO(int document_seq, String emp_no, Timestamp write_date, String emer_yn, String title,
			String status, String name, Timestamp done_date) {
		super();
		this.document_seq = document_seq;
		this.emp_no = emp_no;
		this.write_date = write_date;
	...
	// 문서 번호, 기안일, 문서 양식, 긴급, 제목, 읽음 여부, 기안자 사번, 문서 상태, 완료일 ( 참조 문서함 )
	public DocuInfoListDTO(int document_seq, String emp_no, Timestamp write_date, String emer_yn, String title,
			String read_yn, String status, String name, Timestamp done_date) {
		super();
		this.document_seq = document_seq;
		this.emp_no = emp_no;
		this.write_date = write_date;
